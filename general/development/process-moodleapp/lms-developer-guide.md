...
- Built with Angular and Ionic, following a [hexagonal architecture](../../app/overview.md#architecture): core modules provide the main functionality, and addon modules provide additional features.
- Modules are defined as Angular Modules, and resolved at runtime using Angular's dependency injection framework.
- Pages and navigation are defined using Angular Router, making heavy use of lazy loading.
- Testing:
  - [Acceptance testing](../../app/development/testing/acceptance-testing.md) with Behat, integrated with the Moodle Tracker via a pre-launch remote branch.
  - Unit testing with Jest.

## How the app talks to the LMS {/* #how-the-app-talks-to-the-lms */}

- The REST protocol and the Mobile app web service are automatically enabled on installation, provided the site uses HTTPS.
...
- Performance:
  ...
  - Some web service requests are grouped into a single request using a custom web service.
- Security:
...
- Re-positioning elements (indentation).
- Changes in the course index (communication tools).
- Changes in the default course formats (subsections).
...
- If in doubt, reach out to the Mobile Solutions Team.
